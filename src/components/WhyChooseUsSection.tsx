...
export default function WhyChooseUsSection() {
  ...
  const ctaVariants = {
    ...
    show: { opacity: 1, scale: 1, transition: { duration: 0.6, ease: 'easeOut' as Easing, delay: 0.6 } },
  };
  ...
  return (
    <section className="why-choose-us-section">
      <div className="section-content">
        ...
        <motion.div
          className="value-tiles-grid-wrapper" // Added wrapper for blur effect
        >
          <motion.div
            className="value-tiles-grid"
        ...
        <motion.p
          ...
          variants={itemVariants} // Re-using itemVariants for simplicity
          initial="hidden"
          whileInView="show"
